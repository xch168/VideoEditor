package com.github.xch168.videoeditor.cover;
...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener,
    ...
    public void onReceiverBind() {
        ...
        mStateIcon.setOnClickListener(mOnStateClickListener);
    ...
    private View.OnClickListener mOnStateClickListener = new View.OnClickListener() {
        @Override
