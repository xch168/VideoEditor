...
/**
 * Created by XuCanHui on 2019/12/21.
 */
public class ThumbView extends View {
    ...
    public ThumbView(Context context, Drawable thumbDrawable, int thumbWidth) {
        super(context);
        mThumbWidth = thumbWidth;
        mThumbDrawable = thumbDrawable;
        mExtendTouchSlop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, EXTEND_TOUCH_SLOP,
